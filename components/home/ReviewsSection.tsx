    ...
    <section className="py-20">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-500 mt-3 max-w-xl mx-auto">
          Trusted by jewelry lovers who appreciate timeless style and
          everyday luxury.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {reviews.map((review) => (
          <div
            key={review.name}
            className="bg-white border border-gray-100 rounded-3xl p-8 hover:-translate-y-1 hoverEffect shadow-sm hover:shadow-xl"
          >
