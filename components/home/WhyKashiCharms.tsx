import { Heart, Gift, Truck, ShieldCheck, Sparkles, Star } from "lucide-react";
...
const features = [
  {
    ...
    description: "Every piece is carefully selected before reaching you.",
  },
  {
    icon: Sparkles,
    title: "Affordable Luxury",
    description: "Cute and stylish jewellery without the premium price tag.",
  },
  {
    icon: ShieldCheck,
    title: "Comfortable To Wear",
    description: "Designed for everyday confidence and comfort.",
  },
  {
    icon: Gift,
    title: "Gift Ready",
    description: "Perfect for birthdays, surprises and self-love gifts.",
  },
  {
    icon: Truck,
    title: "PAN India Shipping",
    description: "Secure delivery to your doorstep across India.",
  },
  {
    icon: Star,
    title: "Customer Favourite",
    description: "Jewellery that earns compliments wherever you go.",
  },
];
        ...
        {features.map((feature, i) => {
          ...
          return (
            <ScrollReveal key={feature.title} delay={i * 80}>
              <div className="bg-white rounded-3xl p-6 shadow-sm hover:shadow-xl hoverEffect">
                ...
                <p className="text-sm text-lightColor">{feature.description}</p>
              </div>
            </ScrollReveal>
          );
        })}
