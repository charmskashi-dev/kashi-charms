    ...
    <>
      {!showProduct ? (
        <Link href={"/wishlist"} className="group relative">
          ...
          <span className="absolute -top-1 -right-1 bg-shop-dark-green text-black h-3.5 w-3.5 rounded-full text-xs font-semibold flex items-center justify-center">
